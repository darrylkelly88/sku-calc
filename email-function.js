function generateEmail() {
    ...
    if (deploymentLocation === "In the Cloud") {
        emailBody += "<br><br>Since you have advised that this will be deployed in the cloud. I wanted to make sure you knew that in order for the customer to remain compliant with Red Hat's terms, once purchased they will need to complete Red Hat Cloud Access here: [Link]";
    }
